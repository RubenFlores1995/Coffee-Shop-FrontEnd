    ...
    return (
        <div className="bg-white rounded shadow-lg overflow-hidden">
            ...
            <div className="mt-2 flex gap-4">
                <Link to={'/edit/'+product._id} className="inline-block w-full text-center shadow-md text-sm bg-blue-700 text-white rounded-sm px-4 py-1 font-bold hover:bg-blue-600 hover:cursor-pointer">Edit</Link>
